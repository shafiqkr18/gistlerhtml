    ...
    $("#reset_priority").click(function(){
		...
		function active_reset() {
			...
			$("#form_reset").addClass("btnactive");
				...
				<div class="btn-group custommenu">
				  <button type="button" class="btn btnpriority btntoggle">SET PRIORITIES</button>
				  <button type="button" class="btn dropdown-toggle btntoggle"  aria-haspopup="true" aria-expanded="false">
				...
				<ul class="listside">
					<li><a href="#">Showing 500 Results</a></li>
					<li><a href="#">Checked 10 to compare</a></li>
					<li><?php if(basename($_SERVER['PHP_SELF']) == 'listing2.php'){?><button type="button" class="btngist2">GIST</button> <?php }else{?><button class="btngist"  onclick="window.location.href='listing2.php'" type="button">GIST</button> <? } ?></li>
				</ul>
	<script type="text/javascript">
	...
	*/
				...
				<ul class="listside list-bottom">
						...
						<ul>
							<div class="fixedscroll">
								...
								<li>
									...
									<input type="text" name="min-price" id="min-price" disabled class="filtertxt" value="AED Min"> --- <input type="text" name="max-price" id="max-price" class="filtertxt" disabled value="AED Max">
									<div class="clear10"></div>
					...
					function bedselect2(str){
						...
						/*
						if (document.getElementById(bedstotal2[selected]).checked) {
							for (i = str-1; i <= selected; i++) { 
								document.getElementById(bedstotal[i]).checked = true;
							}
						}
					...
					<li><a href="#">BEDS</a>
						<ul>
							<div class="fixedscroll">
								<li>
									<input type="text" name="min-bed" disabled id="min-bed" class="filtertxt" value="Min"> &nbsp;&nbsp;&nbsp; <input type="text" name="max-bed" id="max-bed" disabled class="filtertxt" value="Max">
									<div class="clear10"></div>
									<div class="filterdvs">
					...
					<li><a href="#">BATHS</a>
						<ul>
							<div class="fixedscroll">
								<li>
									<input type="text" id="min-bath" disabled class="filtertxt" value="Min"> &nbsp;&nbsp;&nbsp; <input type="text" id="max-bath" disabled class="filtertxt" value="Max">
									<div class="clear10"></div>
									<div class="filterdvs">
					...
					<li><a href="#">SIZE</a>
						<ul>
							<div class="fixedscroll">
								<li>
									<input type="text" id="min-size" disabled class="filtertxt" value="Min"> &nbsp;&nbsp;&nbsp; <input type="text" disabled id="max-size" class="filtertxt" value="Max">
									<div class="clear10"></div>
									<div class="filterdvs">
