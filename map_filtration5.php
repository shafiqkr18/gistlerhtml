...
function initialize() {
	...
	var image = 'images/icon-orange.png';
	var image2 = 'images/icon-blue.png';
	var image3 = 'images/icon-red.png';
	var image4 = 'images/icon-purplebig.png';
	var image5 = 'images/icon-purplebig.png';
	
	
	function closeAllInfoWindows() {
	  for (var i=0;i<infobox2.length;i++) {
		 infobox2[i].close();
	  }
	}
