...
function initialize() {
	...
	var image = 'images/icon-agency.png';
	var image2 = 'images/icon-brown.png';
	var image3 = 'images/icon-brown.png';
	var image4 = 'images/icon-brown.png';
	var image5 = 'images/icon-brown.png';
		...
		<div class="infobox-wrapper">
					...
					<div class="sliderdv">
							<div class="slidertopdv">
								...
								<span class="rightcontent">
									<a href="property-detail.php" target="_parent">Details</a> &nbsp; &nbsp; 
								</span>
								<div class="clear"></div>
							</div>
			...
			<div id="infobox2" class="infobox_inner">
					...
					<div class="sliderdv">
							<div class="slidertopdv">
								<span class="leftcontent">
									<input type="checkbox" name="test" id="selectbox12" checked class="checkboxslid"><label for="selectbox12">Select</label>
								</span>
								<span class="rightcontent">
									<a href="property-detail.php" target="_parent">Details</a> &nbsp; &nbsp; 
								</span>
						...
						<div class="sliderdv">
							<div class="slidertopdv">
								<span class="leftcontent">
									<input type="checkbox" name="test" id="selectbox13" checked class="checkboxslid"><label for="selectbox13">Select</label>
								</span>
								<span class="rightcontent">
									<a href="property-detail.php" target="_parent">Details</a> &nbsp; &nbsp; 
								</span>
			...
			<div id="infobox3" class="infobox_inner">
						<div class="sliderdv">
							<div class="slidertopdv">
								<span class="leftcontent">
									<input type="checkbox" name="test" id="selectbox14" checked class="checkboxslid"><label for="selectbox14">Select</label> 
								</span>
								<span class="rightcontent">
									<a href="property-detail.php" target="_parent">Details</a> &nbsp; &nbsp; 
								</span>
			...
			<div id="infobox4" class="infobox_inner">
						<div class="sliderdv">
							<div class="slidertopdv">
								<span class="leftcontent">
									<input type="checkbox" name="test" id="selectbox15" checked class="checkboxslid"><label for="selectbox15">Select</label> 
								</span>
								<span class="rightcontent">
									<a href="property-detail.php" target="_parent">Details</a> &nbsp; &nbsp; 
								</span>
