  ...
  <script>
	...
	<script>
			...
			<div class="container estatelogo">
				<img src="images/agent.png" class="agencylogo">
		...
		<div id="map_load">
			...
			<iframe src="map_filtration5.php" height="95%" width="100%" frameborder="0" scrolling="no" frameborder="0" style="border:0" allowfullscreen></iframe>
		</div>
