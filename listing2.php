...
<link rel="stylesheet" href="//code.jquery.com/ui/1.11.4/themes/smoothness/jquery-ui.css">
  ...
  <script src="src/js/lightslider2.js"></script> 
    <script>
    	 $(document).ready(function() {
  ...
  <div class="bg-wraper parallax-point-event">
	...
	<div class="container">
		...
		function myFunction() {
			...
			<div class="span2 listsliderdv listsliderdv2 listingpage">
			
			
				<ul id="content-slider2" class="content-slider">
					<li class="selectedprop">
						
						<div class="sliderdv">
							<div class="slidertopdv">
								<span class="leftcontent">
									<input type="checkbox" name="test" onclick="get_select(1);" id="selectbox11" class="checkboxslid"><label for="selectbox11">Select</label> &nbsp; <a class="togglebutton" href="javascript:;" onclick="showpopup();" id="togglemap1"><img src="images/icon-map.png"> Map</a>
								</span>
								<span class="rightcontent">
									<a href="property-detail.php">Details</a> 
								</span>
								<div class="clear"></div>
							</div>
			...
			<div class="span8 listsliderdv listsliderdv1 listingpage">
				...
				<ul id="content-slider" class="content-slider">
					...
					<li>
						...
						<div class="sliderdv">
							<div class="slidertopdv">
								<span class="leftcontent">
									<input type="checkbox" name="test" id="selectbox2" onclick="get_select(2);" class="checkboxslid"><label for="selectbox2">Select</label> &nbsp; <a class="togglebutton" href="javascript:;" onclick="showpopup();" id="togglemap2"><img src="images/icon-map.png"> Map</a>
								</span>
								<span class="rightcontent">
					...
					<li>
						...
						<div class="sliderdv">
							<div class="slidertopdv">
								<span class="leftcontent">
									<input type="checkbox" name="test" id="selectbox3" onclick="get_select(3);" class="checkboxslid"><label for="selectbox3">Select</label> &nbsp; <a class="togglebutton" href="javascript:;" onclick="showpopup();" id="togglemap3"><img src="images/icon-map.png"> Map</a>
								</span>
								<span class="rightcontent">
					...
					<li>
						...
						<div class="sliderdv">
							<div class="slidertopdv">
								<span class="leftcontent">
									<input type="checkbox" name="test" id="selectbox4" onclick="get_select(4);" class="checkboxslid"><label for="selectbox4">Select</label> &nbsp; <a class="togglebutton" href="javascript:;" onclick="showpopup();" id="togglemap4"><img src="images/icon-map.png"> Map</a>
								</span>
								<span class="rightcontent">
									<a href="property-detail.php">Details</a> &nbsp; &nbsp; <a href="#" class="closelist"><img src="images/icon-cross.png"></a>
								</span>
					...
					<li>
						...
						<div class="sliderdv">
							<div class="slidertopdv">
								<span class="leftcontent">
									<input type="checkbox" name="test" id="selectbox5" class="checkboxslid"><label for="selectbox5">Select</label> &nbsp; <a class="togglebutton" href="javascript:;" onclick="showpopup();" id="togglemap5"><img src="images/icon-map.png"> Map</a>
								</span>
								<span class="rightcontent">
									<a href="property-detail.php">Details</a> &nbsp; &nbsp; <a href="#" class="closelist"><img src="images/icon-cross.png"></a>
								</span>
					...
					<li>
						...
						<div class="sliderdv">
							<div class="slidertopdv">
								<span class="leftcontent">
									<input type="checkbox" name="test" id="selectbox6" class="checkboxslid"><label for="selectbox6">Select</label> &nbsp; <a class="togglebutton" href="javascript:;" onclick="showpopup();" id="togglemap6"><img src="images/icon-map.png"> Map</a>
								</span>
								<span class="rightcontent">
									<a href="property-detail.php">Details</a> &nbsp; &nbsp; <a href="#" class="closelist"><img src="images/icon-cross.png"></a>
								</span>
					...
					<li>
						...
						<div class="sliderdv">
							<div class="slidertopdv">
								<span class="leftcontent">
									<input type="checkbox" name="test" id="selectbox6" checked class="checkboxslid"><label for="selectbox6">Select</label> &nbsp; <a class="togglebutton" href="javascript:;" onclick="showpopup();" id="togglemap6"><img src="images/icon-map.png"> Map</a>
								</span>
								<span class="rightcontent">
									<a href="property-detail.php">Details</a> &nbsp; &nbsp; <a href="#" class="closelist"><img src="images/icon-cross.png"></a>
								</span>
