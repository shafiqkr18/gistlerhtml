...
function initialize() {
	...
	var image3 = 'images/icon-green.png';
	...
	marker5 = new google.maps.Marker({
        position: {lat: 25.093683043253915, lng: 55.171966552734375},
		map: map,
        visible: true,
		icon: image3
    });

    infobox5= new InfoBox({
	...
	marker6 = new google.maps.Marker({
        position: {lat: 25.068185076358645, lng: 55.21934509277344},
		map: map,
        visible: true,
		icon: image3
    });

    infobox6= new InfoBox({
         content: document.getElementById("infobox6"),
         disableAutoPan: false,
         maxWidth: 150,
         pixelOffset: new google.maps.Size(-140, 0),
         zIndex: null,
...
google.maps.event.addDomListener(window, 'load', initialize);
  ...
  <body>
				...
				<div id="map2" style="width:100%!important; height: 450px"></div>
