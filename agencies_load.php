			...
			<ul style="margin:0px;">
				...
				<div class="sliderdv bgshade2">
					<div class="slidertopdv">
						<span class="leftcontent">
							<input type="checkbox" name="test" checked id="selectbox11" onclick="get_select(1);" class="checkboxslid"><label for="selectbox11">&nbsp;</label>
						</span>
					...
					<div class="proerptysmall">
						<div class="propertysmleft">
							<a href="agency_detail.php"><img src="images/com-logo.png"></a>
						</div>
						<div class="propertysmright">
							<h5><a href="agency_detail.php">Company Name2</a></h5>
				...
				<div class="sliderdv bgshade2">
					...
					<div class="proerptysmall">
						...
						<div class="propertysmright">
							<h5><a href="agency_detail.php">Company Name</a></h5>
							<p>Bay Central | Dubai Marina</p>
							<p>Dubai | UAE</p>
